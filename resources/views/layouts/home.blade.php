<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="caramellatte" class="scroll-smooth">
<head>
    <meta charset="utf-8">
...
<body style="background-color: oklch(98% 0.016 73.684); color: oklch(40% 0.123 38.172);">
<x-banner/>
{{--<livewire:coming-soon/>--}}
<livewire:header/>

<div class="mx-auto max-w-7xl px-6 lg:px-8" style="background-color: oklch(98% 0.016 73.684); color: oklch(40% 0.123 38.172);">
    {{ $slot }}
</div>
